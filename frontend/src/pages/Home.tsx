...
export const Home: React.FC = () => {
  ...
  return (
    <div className="space-y-6 pb-12">
      {/* HERO BANNER */}
      <section className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-purple-900/90 via-indigo-900/90 to-slate-900 p-4 sm:p-5 md:p-6 border border-purple-800/40 shadow-xl">
        <div className="absolute top-0 right-0 -mr-16 -mt-16 w-48 h-48 bg-purple-500/10 rounded-full blur-2xl pointer-events-none"></div>
        <div className="relative z-10 max-w-2xl space-y-2.5">
          <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-purple-500/20 border border-purple-500/30 text-purple-300 text-[11px] font-bold">
            <Sparkles className="w-3 h-3 text-yellow-400" /> Futsal FEFUSA Mendoza
          </div>
          <h1 className="text-xl sm:text-2xl md:text-3xl font-black text-white tracking-tight leading-snug">
            Prode de Futsal
          </h1>
          <p className="text-slate-300 text-xs sm:text-sm leading-relaxed">
            Demostrá tus conocimientos del futsal mendocino. Acertá resultados exactos{' '}
          ...
          <div className="flex flex-wrap gap-2.5 pt-1">
            <Link
              to="/prode"
              className="px-4 py-2 rounded-xl bg-purple-600 hover:bg-purple-500 text-white font-bold text-xs uppercase tracking-wider transition shadow-md shadow-purple-600/30 flex items-center gap-1.5"
            >
              Jugar al Prode <ChevronRight className="w-3.5 h-3.5" />
            </Link>
            <Link
              to="/leaderboard"
              className="px-4 py-2 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-200 font-bold text-xs uppercase tracking-wider border border-slate-700 transition"
            >
              Ver Tabla del Prode
            </Link>
          </div>

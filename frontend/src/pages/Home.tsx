...
import { Calendar, Radio, Award, Trophy, ChevronRight, Sparkles, Flame, Shield, ArrowUpRight } from 'lucide-react';
      ...
      <section className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-purple-900 via-indigo-900 to-slate-900 p-6 md:p-8 border border-purple-800/40 shadow-2xl">
        ...
        <div className="relative z-10 max-w-2xl space-y-3">
          ...
          <h1 className="text-3xl md:text-5xl font-black text-white tracking-tight leading-tight">
            Pronósticos Deportivos <br />
            <span className="bg-gradient-to-r from-yellow-400 via-purple-300 to-indigo-300 bg-clip-text text-transparent">
              100% Recreativos
            </span>
          </h1>
          <p className="text-slate-300 text-sm md:text-base leading-relaxed">
            Demuestra tus conocimientos en el futsal mendocino (FEFUSA). Apuesta con <strong className="text-yellow-400">puntos virtuales</strong> sin riesgo, escala en el ranking y gana la liga recreativa.
          </p>
          <div className="flex flex-wrap gap-3 pt-2">
            ...
            >
              Ver Proximos Partidos <ChevronRight className="w-4 h-4" />
            </Link>
            <Link
              to="/ranking"
            ...
            return (
              ...
              >
                ...
                <div className="pt-1 flex items-center justify-between text-xs border-t border-slate-800/60">
                  ...
                  >
                    + Mercados <ArrowUpRight className="w-3.5 h-3.5" />
                  </Link>
                </div>
              </div>
            );
